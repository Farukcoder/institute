...
<body onload="onload_hide_fun();">
    <div id="wrapper">
        ...
        <header style="padding-left:120px;">
              ...
              <div class="body" style="width:67%;height:1300px;background:#E5E8E8;float:left;border:1px solid #F4F6F6">
               <h3 style="text-align:center;font-size:32px;padding-top:30px;color:black;background:#9C7552">Civil Department</h3>
